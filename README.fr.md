...
![router-hub](/web/default/public/logo.png)
...
<p align="center">
  <a href="https://raw.githubusercontent.com/jorlash/router-hub/main/LICENSE">
    <img src="https://img.shields.io/github/license/jorlash/router-hub?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/jorlash/router-hub/releases/latest">
    <img src="https://img.shields.io/github/v/release/jorlash/router-hub?color=brightgreen&include_prereleases" alt="version">
  </a><!--
  --><a href="https://hub.docker.com/r/CalciumIon/router-hub">
    <img src="https://img.shields.io/badge/docker-dockerHub-blue" alt="docker">
  </a><!--
  --><a href="https://goreportcard.com/report/github.com/jorlash/router-hub">
    <img src="https://goreportcard.com/badge/github.com/jorlash/router-hub" alt="GoReportCard">
  </a>
</p>

<p align="center">
  <a href="https://trendshift.io/repositories/20180" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20180" alt="jorlash%2Frouter-hub | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
  <br>
  <a href="https://hellogithub.com/repository/jorlash/router-hub" target="_blank">
    <img src="https://api.hellogithub.com/v1/widgets/recommend.svg?rid=539ac4217e69431684ad4a0bab768811&claim_uid=tbFPfKIDHpc4TzR" alt="Featured｜HelloGitHub" style="width: 250px; height: 54px;" width="250" height="54" />
  </a><!--
  --><a href="https://www.producthunt.com/products/router-hub/launches/router-hub?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-router-hub" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="Router Hub - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
<p align="center">
  ...
  --><a href="https://www.compshare.cn/?ytag=GPU_yy_gh_routerhub" target="_blank">
...
<p align="center">
  <a href="https://www.jetbrains.com/?from=router-hub" target="_blank">
    <img src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" alt="JetBrains Logo" width="120" />
  </a>
</p>

<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=router-hub">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
```bash
# Cloner le projet
git clone https://github.com/jorlash/router-hub.git
cd router-hub
...
docker pull jorlash/router-hub:latest

# Utilisation de SQLite (par défaut)
docker run --name router-hub -d --restart always \
  -p 3000:3000 \
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  jorlash/router-hub:latest
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.routerhub.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.routerhub.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/jorlash/router-hub)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.routerhub.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.routerhub.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.routerhub.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.routerhub.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.routerhub.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.routerhub.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- 🔍 Requête de quota d'utilisation de clé (avec [router-hub-key-tool](https://github.com/jorlash/router-hub-key-tool))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://docs.routerhub.pro/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.routerhub.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://docs.routerhub.pro/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.routerhub.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://docs.routerhub.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://docs.routerhub.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.routerhub.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.routerhub.pro/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://doc.routerhub.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://doc.routerhub.pro/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://docs.routerhub.pro/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://docs.routerhub.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.routerhub.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.routerhub.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.routerhub.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.routerhub.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.routerhub.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.routerhub.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.routerhub.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.routerhub.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.routerhub.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.routerhub.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.routerhub.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `jorlash/router-hub:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `router-hub` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `router-hub` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.routerhub.pro/en/docs/installation/config-maintenance/environment-variables)
...
| Projet | Description |
|------|------|
| [router-hub-key-tool](https://github.com/jorlash/router-hub-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [router-hub-horizon](https://github.com/jorlash/router-hub-horizon) | Version optimisée haute performance de Router Hub |
...
| 📘 FAQ | [FAQ](https://docs.routerhub.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.routerhub.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.routerhub.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.routerhub.pro/en/docs) |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=jorlash/router-hub&type=Date)](https://star-history.com/#jorlash/router-hub&Date)
...
### 💖 Merci d'utiliser Router Hub

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.routerhub.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/jorlash/router-hub/issues)** • **[Dernière version](https://github.com/jorlash/router-hub/releases)**

<sub>Construit avec ❤️ par jorlash</sub>
