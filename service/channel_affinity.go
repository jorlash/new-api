...
import (
	...
	"github.com/jorlash/router-hub/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "router-hub:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "router-hub:channel_affinity_usage_cache_stats:v1"
)
